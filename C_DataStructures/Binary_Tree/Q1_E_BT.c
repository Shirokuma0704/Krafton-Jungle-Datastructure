...
int main()
{
    ...
    printf("1: 이진 트리 1 만들기.\n");
    printf("2: 이진 트리 2 만들기.\n");
    printf("3: 두 트리의 구조가 같은지 확인.\n");
    printf("0: 종료;\n");
...
int identical(BTNode *tree1, BTNode *tree2)
{
    ...
    int right_result = 0;
    right_result = identical(tree1->right, tree2->right);
        if (right_result == 0)
            return 0;

    int left_result = 0;
    left_result = identical(tree1->left, tree2->left);
